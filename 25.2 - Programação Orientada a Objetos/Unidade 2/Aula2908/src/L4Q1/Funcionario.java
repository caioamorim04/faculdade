...
public class Funcionario {
    ...
    public double calcularIrpf() {
        ...
        if (salario > 1903.98) {
            double base = Math.min(salario, 2826.65) - 1903.98;
            imposto += base * 0.075;
        }
        if (salario > 2826.65) {
            double base = Math.min(salario, 3751.05) - 2826.65;
            imposto += base * 0.15;
        }
        if (salario > 3751.05) {
            double base = Math.min(salario, 4664.68) - 3751.05;
            imposto += base * 0.225;
        }
        if (salario > 4664.68) {
            double base = salario - 4664.68;
            imposto += base * 0.275;
        }
